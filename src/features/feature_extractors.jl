...
pull_features!{F<:Real}(::AbstractFeatureExtractor, features::Vector{F}, rec::SceneRecord, roadway::Roadway, vehicle_index::Int) = error("Not Implemented")

type FeatureExtractor <: AbstractFeatureExtractor
    features::Vector{AbstractFeature}
end
Base.length(ext::FeatureExtractor) = length(ext.features)
function pull_features!{F<:Real}(ext::FeatureExtractor, features::Vector{F}, rec::SceneRecord, roadway::Roadway, vehicle_index::Int)
