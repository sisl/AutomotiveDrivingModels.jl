...
function CLBNTrainParams{A<:DriveAction}(::Type{A},
    ...
    CLBNTrainParams{A}(max_n_parents, max_n_train_examples, prime_history, prior, features, context)
end
...
#                 for target in targets
#                     v = convert(Float64, get(target, rec, roadway, vehicle_index, pastframe))
...
#     Distributions.fit(::Type{NannableConditionalLinearGaussianCPD},
#     data::DataFrame,
#     target::NodeName,
