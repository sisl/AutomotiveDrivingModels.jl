...
Distributions.pdf(model::WrappedLaneFollowingDriver{A}, a::A) = pdf(model.submodel, convert(Accel, a))
Distributions.logpdf(model::WrappedLaneFollowingDriver{A}, a::A) = logpdf(model.submodel, convert(Accel, a))