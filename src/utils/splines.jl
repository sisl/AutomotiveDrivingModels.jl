...
# TODO:
# make function in Curves.jl for converting entire curve

# function plot_spline(spline_coeffs, t_arr::Vector{Float64})
# 	figure()
# 	n = length(t_arr)
# 	plot([1:n], sample_spline(spline_coeffs, t_arr))
# end
...
# function get_spline()
# 	spx = _fit_open([0.0,1.0])
# 	spy = _fit_open([0.0,0.0])
# 	(spx, spy)
# end
