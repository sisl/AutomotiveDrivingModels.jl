let
    ...
    push!(rec, scene)
    @test rec[2][1].state == get_state(trajdata, 1, 2)
    @test rec[2][1].def == get_def(trajdata, 1)
    @test rec[2][2].state == get_state(trajdata, 2, 2)
    @test rec[2][2].def == get_def(trajdata, 2)
    @test rec[1][1].state == get_state(trajdata, 1, 1)
    @test rec[1][1].def == get_def(trajdata, 1)
    @test rec[1][2].state == get_state(trajdata, 2, 1)
    @test rec[1][2].def == get_def(trajdata, 2)
