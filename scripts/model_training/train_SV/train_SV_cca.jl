...
const BEST_MODEL_CSV_FILE = joinpath(EVALUATION_DIR, "best_model_sv" * SAVE_FILE_MODIFIER * ".csv")
...
behavior_type = VehicleBehaviorLinearGaussian
behavior_name = "Single Variable"
