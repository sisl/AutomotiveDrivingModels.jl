...
#                                             LG_TrainParams(indicators=INDICATOR_SET_SMALL),
#                                             [
#                                                 BehaviorParameter(:ridge_regression_constant, [0.0,1e-5,1e-4,1e-3], 2) # ,1e-2,0.1,0.25,0.5,0.9
#                                             ])
# behaviorset["Random Forest"] = BehaviorTrainDefinition(
#                                             GRF_TrainParams(indicators=INDICATOR_SET_SMALL),
#                                             [
#                                                 BehaviorParameter(:ntrees, [3,10], 2), # /home/tim/Documents/papers/2016_itsc_scenegen_wheeler/code/full_scene/output/dset_FG.jld
...
#                                             ])
# behaviorset["Dynamic Forest"] = BehaviorTrainDefinition(
#                                             DF_TrainParams(indicators=INDICATOR_SET_SMALL),
#                                             [
#                                                 BehaviorParameter(:ntrees, [3,10], 2), # ,20,30
#                                                 BehaviorParameter(:max_tree_depth, [2,3,4], 2),
#                                                 # BehaviorParameter(:use_PCA, [false, true], 1),
...
# behaviorset["Bayesian Network"] = BehaviorTrainDefinition(
#                                             BN_TrainParams(
#                                                 indicators=INDICATOR_SET_SMALL,
#                                                 preoptimize_target_bins=true,
#                                                 preoptimize_indicator_bins=true,
#                                                 optimize_structure=true,
#                                                 optimize_target_bins=false,
...
behaviorset["Linear Bayesian"] = BehaviorTrainDefinition(
                                            ...
                                            [
                                                ...
                                                # BehaviorParameter(:ridge_regression_constant, [0.1], 1),
                                                # BehaviorParameter(:min_σ_lat, [1e-7, 1e-6, 1e-5], 2),
                                                # BehaviorParameter(:min_σ_lon, [1e-7, 5e-6, 1e-6], 2),
                                                # BehaviorParameter(:min_σ_lat, [1e-9], 1),
                                                BehaviorParameter(:max_parents, [2], 1),
                                            ])
# behaviorset["Mixture Regression"] = BehaviorTrainDefinition(
